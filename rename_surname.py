...
# Расширения файлов, в которых будем искать
EXTENSIONS = ('.html', '.htm', '.js', '.css', '.json', '.xml', '.txt', '.md', '.rss', '.csv', '.yml', '.yaml')

# Все варианты замены (с учётом регистра)
REPLACEMENTS = {
    # Стандартный вариант с заглавной
...
def main():
    ...
    for root, dirs, files in os.walk('.'):
        # Исключаем системные и медиа-папки
